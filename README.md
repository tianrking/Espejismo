...
In `v0.1.4`, TUN mode routes desktop TCP/UDP flows through interactive tunnel
...
| --- | --- | --- |
| `ESPEJISMO_VERSION` | `latest` | Release tag such as `v0.1.4` |
