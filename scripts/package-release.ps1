...
Copy-Item "scripts/setup-windows.ps1", "scripts/e2e_smoke.sh", "scripts/e2e_smoke.ps1", "scripts/stress_smoke.sh", "scripts/stress_smoke.ps1", "scripts/benchmark_mux.sh", "scripts/install-ubuntu-remote.sh" "$Out/scripts/"
