...
ESPEJISMO_TCP_USER_TIMEOUT_MS="${ESPEJISMO_TCP_USER_TIMEOUT_MS:-30000}"
ESPEJISMO_TCP_SEND_BUFFER_BYTES="${ESPEJISMO_TCP_SEND_BUFFER_BYTES:-1048576}"
ESPEJISMO_TCP_RECV_BUFFER_BYTES="${ESPEJISMO_TCP_RECV_BUFFER_BYTES:-1048576}"
ESPEJISMO_MUX_MODE="${ESPEJISMO_MUX_MODE:-yamux}"
ESPEJISMO_NATIVE_MUX_INITIAL_WINDOW_BYTES="${ESPEJISMO_NATIVE_MUX_INITIAL_WINDOW_BYTES:-1048576}"
ESPEJISMO_NATIVE_MUX_STREAM_BUFFER_FRAMES="${ESPEJISMO_NATIVE_MUX_STREAM_BUFFER_FRAMES:-128}"
ESPEJISMO_NATIVE_MUX_SEND_QUEUE_FRAMES="${ESPEJISMO_NATIVE_MUX_SEND_QUEUE_FRAMES:-64}"
ESPEJISMO_NATIVE_MUX_IDLE_TIMEOUT_SECS="${ESPEJISMO_NATIVE_MUX_IDLE_TIMEOUT_SECS:-300}"
ESPEJISMO_NATIVE_MUX_DRAIN_TIMEOUT_SECS="${ESPEJISMO_NATIVE_MUX_DRAIN_TIMEOUT_SECS:-30}"
ESPEJISMO_PACING_ENABLED="${ESPEJISMO_PACING_ENABLED:-true}"
ESPEJISMO_PACING_MAX_BYTES_PER_SEC="${ESPEJISMO_PACING_MAX_BYTES_PER_SEC:-0}"
ESPEJISMO_PACING_BURST_BYTES="${ESPEJISMO_PACING_BURST_BYTES:-65536}"
ESPEJISMO_PACING_MIN_WRITE_BYTES="${ESPEJISMO_PACING_MIN_WRITE_BYTES:-1024}"
ESPEJISMO_OBFUSCATION_PROFILE="${ESPEJISMO_OBFUSCATION_PROFILE:-balanced}"
ESPEJISMO_CHUNK_POLICY="${ESPEJISMO_CHUNK_POLICY:-balanced}"
ESPEJISMO_RANDOMIZE_CHUNKS="${ESPEJISMO_RANDOMIZE_CHUNKS:-true}"
ESPEJISMO_MIN_CHUNK="${ESPEJISMO_MIN_CHUNK:-4096}"
ESPEJISMO_MAX_CHUNK="${ESPEJISMO_MAX_CHUNK:-16384}"
ESPEJISMO_STEALTH_FRAME_SIZE="${ESPEJISMO_STEALTH_FRAME_SIZE:-4096}"
ESPEJISMO_STEALTH_TICK_MS="${ESPEJISMO_STEALTH_TICK_MS:-50}"
...
ESPEJISMO_CLIENT_TUNNEL_POOL_MIN_CONNECTIONS="${ESPEJISMO_CLIENT_TUNNEL_POOL_MIN_CONNECTIONS:-1}"
ESPEJISMO_CLIENT_TUNNEL_POOL_MAX_CONNECTIONS="${ESPEJISMO_CLIENT_TUNNEL_POOL_MAX_CONNECTIONS:-4}"
ESPEJISMO_CLIENT_TUNNEL_POOL_INTERACTIVE_LANES="${ESPEJISMO_CLIENT_TUNNEL_POOL_INTERACTIVE_LANES:-1}"
ESPEJISMO_CLIENT_TUNNEL_POOL_BULK_LANES="${ESPEJISMO_CLIENT_TUNNEL_POOL_BULK_LANES:-2}"
ESPEJISMO_CLIENT_TUNNEL_POOL_MAX_RECONNECT_ATTEMPTS="${ESPEJISMO_CLIENT_TUNNEL_POOL_MAX_RECONNECT_ATTEMPTS:-3}"
